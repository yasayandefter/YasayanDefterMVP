...
(async () => {
  ...
  console.log(`PASS  public-first Edge E2E; standardMs=${standardDurationMs}; currentMs=${currentDurationMs}; standard/current/ambiguous/comparison+isolation=10; contamination=0; API=${apiResponses.length}; wikimediaApiFetches=0; unexpected401403500=0; consoleErrors=0; pageErrors=0`);
