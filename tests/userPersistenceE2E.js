...
(async () => {
  ...
  console.log("PASS  real Edge authenticated USER Defterim, authoritative zero/first streak and weekly goal, refresh, logout/login restore, server ownership, and no local notebook shadow");
