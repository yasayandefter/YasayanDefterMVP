...
(async () => {
  ...
  console.log(`PASS  real Edge live current quality E2E; queries=6; technologyDomains=${results[0].domains}; htmlLeaks=0; genericFillers=0; consoleErrors=0; pageErrors=0; unexpected401403500=0; durations=${results.map(item => item.durationMs).join(",")}`);
