...
const SIGNALS = [
  ...
  { pattern: /\bguncel\b|\bhaber\w*\b|\bson dakika\b|\bson deprem\b|\bbreaking\b|\bnews\b|\bson aciklama\b|\baciklandi mi\b|\bsonuclandi mi\b/, window: "recent" }
];
...
function detectCategory(query) {
  ...
  for (const category of Object.keys(CATEGORY_SIGNALS)) if (CATEGORY_SIGNALS[category].test(text)) return category;
  return "general";
}
