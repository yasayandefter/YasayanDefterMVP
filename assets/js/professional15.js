(function () {
    ...
    function addProfilePanel() {
        ...
        document.getElementById("changePasswordButton").addEventListener("click", function () { window.dispatchEvent(new CustomEvent("yasayan-open-password")); });
        renderProfile();
    }
    function renderProfile() {
        ...
        var changePassword = document.getElementById("changePasswordButton"); if (changePassword) changePassword.hidden = !(auth.authenticated === true && auth.user);
