(function () {
  ...
  function homePanel(user) {
    ...
    var greeting = el("div", { class: "yd-home-greeting" });
    greeting.append(el("p", { class: "yd-eyebrow" }, "ÇALIŞMA ALANIN"), el("h1", { id: "yd-home-title", tabindex: "-1" }, "Merhaba" + (name ? ", " + name : "")), el("p", { class: "yd-home-prompt" }, "Merakını bir sonraki çalışmana dönüştür."));
    ...
    var submit = el("button", { type: "submit", "aria-label": "Araştırmayı başlat" }, "Araştır");
    ...
    intro.append(search, el("p", { class: "yd-home-search-note" }, "Bir soru sor, bir konuyu keşfet ya da fikrini derinleştir."));
    var actions = el("section", { class: "yd-home-actions", "aria-labelledby": "yd-home-actions-title" });
    var actionsHead = el("div", { class: "yd-home-section-head" });
    actionsHead.append(el("div", {}, undefined), el("p", { class: "yd-eyebrow" }, "ALANLAR"));
    actionsHead.firstChild.append(el("h2", { id: "yd-home-actions-title" }, "Nereden devam etmek istersin?"), el("p", {}, "Tüm çalışmaların aynı defterde, birbirine bağlı."));
    ...
    actions.append(actionsHead, cards);
    main.append(intro);
    var metrics = el("section", { class: "yd-metrics-rail", "aria-label": "Bugünün özeti" });
    var metricsTitle = el("div", { class: "yd-metrics-title" });
    metricsTitle.append(el("p", { class: "yd-eyebrow" }, "RİTMİN"), el("strong", {}, "Bugünkü ilerleme"));
    ...
    var continuity = el("section", { class: "yd-home-continuity", "aria-labelledby": "yd-continuity-title" });
    var continuityHead = el("div", { class: "yd-home-section-head yd-continuity-head" });
    var continuityCopy = el("div", {});
    continuityCopy.append(el("h2", { id: "yd-continuity-title" }, "Kaldığın yerden devam et"), el("p", {}, "Son çalışmaların ve sana uygun kısa yollar."));
    continuityHead.append(continuityCopy, el("p", { class: "yd-eyebrow" }, "DEVAMLILIK"));
    ...
    main.append(metrics, actions);
    continuity.append(continuityHead, suggestions);
    var intelligence = document.getElementById("workspaceHome");
    if (intelligence) continuity.append(intelligence);
    ...
    empty.append(emptyCopy, emptyAction); continuity.append(empty); main.append(continuity);
    panel.append(main);
    return panel;
  }
